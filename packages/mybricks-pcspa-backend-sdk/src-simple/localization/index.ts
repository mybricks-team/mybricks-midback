...
const localization: TProcessor = async ({ inputs, outputs }: { inputs: TInputs, outputs: TOutputs }) => {
    const { req, appConfig, json } = inputs
    const { template, app_type, hasOldComLib } = outputs
